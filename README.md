...
| Config |
| ------ |
| [~/.config](https://github.com/samwhelp/ubuntu-iso-builder-respin-kde-plasma/tree/main/template/asset/overlay/etc/skel/.config) |
| [/usr/share/glib-2.0/schemas](https://github.com/samwhelp/ubuntu-iso-builder-respin-kde-plasma/tree/main/template/asset/overlay/usr/share/glib-2.0/schemas) |
| [/etc/dconf/db/distro.d](https://github.com/samwhelp/ubuntu-iso-builder-respin-kde-plasma/tree/main/template/asset/overlay/etc/dconf/db/distro.d) |
...
> clone [ubuntu-iso-builder-respin-kde-plasma](https://github.com/samwhelp/ubuntu-iso-builder-respin-kde-plasma)

``` sh
git clone https://github.com/samwhelp/ubuntu-iso-builder-respin-kde-plasma.git
```


> change dir to `ubuntu-iso-builder-respin-kde-plasma`

``` sh
cd ubuntu-iso-builder-respin-kde-plasma
```
...
> The resulting ISO file will be placed on `ubuntu-iso-builder-remix-kde-plasma/dist`
